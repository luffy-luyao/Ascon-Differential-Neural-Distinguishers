...
runcount = np.array(['9\n(01010101)','9\n(10101010)','10\n(01010100)','10\n(10101011)'])
accuracy = np.array([100,50.28,50.27,50.27])
...
ax.set_title('Variant Ascon-p[8] Permutation Run Statistics',
...
'''
plt.tight_layout()
plt.savefig('变种Ascon-p[8]置换游程统计表.pdf', format='pdf')
plt.savefig('变种Ascon-p[8]置换游程统计表.png', dpi=300, bbox_inches='tight')  # 更高DPI用于印刷
plt.show()